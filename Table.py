...
class Table(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.model.setHorizontalHeaderLabels(['Название', 'Жанр', 'Автор', 'Дата создания', 'Альбом', 'Скачать музыку', 'Удалить музыку'])
...
#
        for tup in self.data:
            ...
            flag = False
            row += 1
        self.buttonGroupDelete.buttonClicked[int].connect(self.deleteMusic())
